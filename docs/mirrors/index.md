...
???+ note "帮助项目完善更多境外、海外软件源"
    ...
    作者没有精力持续维护列表中的这些境外、海外镜像站，如果你想补充更多软件源或更正当前已有，请修改脚本内的 [`mirror_list_abroad 数组变量`](https://github.com/SuperManito/LinuxMirrors/blob/main/ChangeMirrors.sh#L64 "https://github.com/SuperManito/LinuxMirrors/blob/main/ChangeMirrors.sh#L64") 并按照下面的编辑规范进行修改
